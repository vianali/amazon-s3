...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { attachment: @picture.attachment, name: @picture.name } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { attachment: @picture.attachment, name: @picture.name } }
